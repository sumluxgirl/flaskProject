...
def create_subjects():
    ...
    subject_line_transmission = Subject(
        ...
        count_hours=6,
        descrition='Cистема, позволяющая передавать энергию постоянного или переменного токов, например волновод, квазиоптическая и оптическая линия передачи. Поперечные размеры таких линий малы по сравнению с продольными, а часто и с длиной волны передаваемых колебаний. Из-за этого появился термин "длинные линии".'
    )
